...
figure; plotPoints(babiaGora); title("Przed"); grid on; hold on;
figure; plotPoints(affineTransform(babiaGora, 2, 2, 2, 0, 0, 0, 10, 10, 10)); title("Po"); grid on;
